	...
	public static void fightTest2() {
		...
		Random rand1 = new Random();
		{
			if (rand1.nextInt(2) < 1) {
				...
				System.out.println("召唤师1 " + "Attack:" + ((Unit) hero1).getAttack() + " Defense:" + ((Unit) hero1).getDefense() + " Life:" + ((Unit) hero1).getLife());
			} else {
				...
				System.out.println("战士1 " + "Attack:" + ((Unit) hero1).getAttack() + " Defense:" + ((Unit) hero1).getDefense() + " Life:" + ((Unit) hero1).getLife());
			}
		...
		Random rand2 = new Random();
		{
			if (rand2.nextInt(2) < 1) {
				hero2 = new Summoner("召唤师2",
						SUMMONER_ATTACK_MIN + rand1.nextInt(SUMMONER_ATTACK_MAX - SUMMONER_ATTACK_MIN + 1),
						SUMMONER_DEFENSE, SUMMONER_LIFE);
				System.out.println("召唤师2 " + "Attack:" + ((Unit) hero2).getAttack() + " Defense:" + ((Unit) hero2).getDefense() + " Life:" + ((Unit) hero2).getLife());
			} else {
				hero2 = new Soilder("战士2",
						SOLDIER_ATTACK_MIN + rand1.nextInt(SOLDIER_ATTACK_MAX - SOLDIER_ATTACK_MIN + 1),
						SOLDIER_DEFENSE, SOLDIER_LIFE);
				System.out.println("战士2 " + "Attack:" + ((Unit) hero2).getAttack() + " Defense:" + ((Unit) hero2).getDefense() + " Life:" + ((Unit) hero2).getLife());
			}
